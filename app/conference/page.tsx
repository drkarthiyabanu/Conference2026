  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative z-10">
        ...
        {/* --- HERO SECTION --- */}
        <div className="relative pt-[2%] text-white pt-32 pb-20 px-6">
        ...
        <section id="publication" className="py-20 px-6 bg-white">
          <div className="max-w-6xl pt-[2%] mx-auto grid md:grid-cols-2 gap-12">
        ...
        <section id="contact" className="py-20 px-6 bg-slate-50 border-t border-gray-200">
          <div className="max-w-6xl pt-[2%] mx-auto text-center">
            <div className="mb-16">
