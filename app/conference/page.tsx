            ...
            <div className="grid lg:grid-cols-3 gap-12">
              ...
              <div className="bg-slate-900 text-white p-8 rounded-2xl shadow-xl">
                ...
                <div className="space-y-4">
                  <DateItem label="Abstract Submission" date="12th March 2026" />
                  <DateItem label="Notification of Acceptance" date="14th March 2026" />
                  <DateItem label="Camera-Ready Paper" date="16 March 2026" />
                  <DateItem label="Awards Nomination" date="12th March 2026" />
